...
class uresult_page extends StatefulWidget {
  const uresult_page({Key? key}) : super(key: key);
  @override
  _uresult_pageState createState() => new _uresult_pageState();
}

class _uresult_pageState extends State<uresult_page> {
